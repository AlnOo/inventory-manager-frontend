...
class Inventory extends Component {
    ...
    deleteProduct = (productID, index) => {
        ...
        // axios({
        //     method: 'delete',
        //     url: 'https://infinite-brushlands-33577.herokuapp.com/products/' + productID,
        //     headers: { 'Authorization': this.props.token }
        // })
    ...
    updateProduct = (product_name, description, price, quantity) => {
        ...
        axios({
            method: 'patch',
            url: 'https://infinite-brushlands-33577.herokuapp.com/products/' + this.state.productToUpdate,
            data: updatedProduct,
            headers: { 'Authorization': this.props.token }
        })
            .then((response) => {
